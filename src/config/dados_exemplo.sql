...
-- Inserir dados de exemplo para atendimentos
INSERT INTO atendimentos (paciente_id, medico_id, data_atendimento, hora_atendimento, tipo_atendimento, observacoes) VALUES
(1, 1, '2024-03-20', '09:00:00', 'consulta', 'Paciente com dor de cabeça'),
(2, 2, '2024-03-20', '10:30:00', 'retorno', 'Avaliação de exames cardíacos'),
(3, 3, '2024-03-21', '14:00:00', 'consulta', 'Dor no joelho direito'),
(4, 4, '2024-03-21', '15:30:00', 'emergencia', 'Febre alta e tosse'),
(5, 5, '2024-03-22', '11:00:00', 'consulta', 'Avaliação de dor de cabeça frequente');
